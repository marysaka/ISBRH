...
@Mod(modid = "isbrhcore", name = "ISBRH", acceptedMinecraftVersions = "[1.8]")
public class ISBRH {
    ...
    public void init(FMLInitializationEvent event) {
        ...
        // Render Item Hook
        RenderItem item = new RenderItemISBRH(mc.getTextureManager(), modelManager);
        ...
        BlockRendererDispatcher rendererDispatcher = new ISBRHDispatcher(modelManager.getBlockModelShapes(), mc.gameSettings);
